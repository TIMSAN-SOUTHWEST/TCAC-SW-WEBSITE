...
const MealManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error.response?.data?.error || error.message || "Failed to create meal.",
        status: "error",
        duration: 3000,
        isClosable: true,
      });
  ...
  const handleEditSubmit = async (e) => {
    e.preventDefault();
    try {
      await api.put(`/meals/${editMealId}`, {
        name: mealName,
        type: mealType,
        day: mealDay,
        startTime,
      ...
      toast({
        title: "Error",
        description: error.response?.data?.error || error.message || "Failed to update meal.",
        status: "error",
        duration: 3000,
        isClosable: true,
      });
  ...
  const handleDeleteMeal = async () => {
    ...
    try {
      await api.delete(`/meals/${selectedMeal._id}`);
      toast({
        title: "Deleted",
      ...
      toast({
        title: "Error",
        description: error.response?.data?.error || error.message || "Failed to delete meal.",
        status: "error",
        duration: 3000,
        isClosable: true,
      });
